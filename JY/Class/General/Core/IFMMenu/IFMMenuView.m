...
- (UIView *)makeContentView{
    ...
    if (_menu.showShadow) {
        ...
        self.layer.shadowColor = [[UIColor colorWithHexString:@"DCE5EB"] CGColor];
...
//        [button setBackgroundImage:[self createImageWithColor:BlackForMenuHL] forState:UIControlStateHighlighted];
        if (_menu.defaultSelect){
            if (itemNum == _menu.selectRow){
                [button setTitleColor:[UIColor colorWithHexString:@"0292FD"] forState:UIControlStateNormal];
            }
        }
