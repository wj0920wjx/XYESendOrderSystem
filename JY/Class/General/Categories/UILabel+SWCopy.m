...
//  NewAlphaFish
//
//  Created by  shanayoung on 2018/5/15.
//  Copyright © 2018年 遨游大师. All rights reserved.
//

#import "UILabel+SWCopy.h"

@implementation UILabel (SWCopy)
...
- (void)handleTap:(UIGestureRecognizer *)g {
    ...
    CGRect reect = CGRectMake(self.frame.origin.x, self.frame.origin.y - self.frame.size.height/2, self.frame.size.width, self.frame.size.height);
    [[UIMenuController sharedMenuController] setTargetRect:reect inView:self];
